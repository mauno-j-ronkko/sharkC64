...
the module variables are initialized. It can perform any actions that are needed before the module can be used 
by other parts of the program.

The module initialization block is enclosed by the keywords `init` and `end`, 
...
The module initialization is executed only once. 
